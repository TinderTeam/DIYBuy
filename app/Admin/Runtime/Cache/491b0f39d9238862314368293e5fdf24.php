<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE HTML><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="description" content="运用CSS3和CSS滤镜做的精美的登录界面，无用到图片的喔！"><meta http-equiv="author" content="chenjinfei"><meta http-equiv="date" content="2012-2-6"><title>DIY团管理员登录</title><style type="text/css">    body { 
        margin:0; 
        padding:0; 
    ...
    .loginForm h1 { 
        text-shadow: 0 1px 0 rgba(255, 255, 255, .7), 0px 0px 0 rgba(0, 0, 0, .5); 
        ...
        letter-spacing: 4px; 
        font:normal 26px/1 STKaiti, sans-serif; 
    } 
    fieldset { 
        border:none; 
        padding:10px 10px 0; 
    ...
    filter: progid:DXImageTransform.Microsoft.Gradient(gradientType=1,startColorStr='#FF6900',EndColorStr='#FF9800'); 
    ...
    </style></head><body><div class="wrap"><form name="form" action="__URL__/check" method="post"><section class="loginForm"><header><h1>DIY团管理员登陆</h1></header><div class="loginForm_content"><fieldset><div class="inputWrap"><input type="text" name="admin_name" placeholder="邮箱/手机号" autofocus required></div><div class="inputWrap"><input type="password" name="admin_pwd" placeholder="请输入密码" required></div></fieldset><fieldset><input type="checkbox" checked="checked"><span>下次自动登录</span></fieldset><fieldset><input type="submit" value="登录"><a href="#">忘记密码？</a><a href="#">注册</a></fieldset></div></section></form></div></body></html><?php
 ?>