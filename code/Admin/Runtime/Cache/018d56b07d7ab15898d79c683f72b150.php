    ...
    <div id="PageBody">   <!--页面主体-->
        <div id="LeftNav">   <!--左侧导航-->
            <div id="Menu">
                ...
                <li><a href="__URL__/productlist.html"><font color=#000 size=2><b>产品列表</b></font></a></li>
                <li><a href="__URL__/productupload.html"><font color=#000 size=2><b>新增产品</b></font></a></li>
        ...
        <div id="IdList">
            ...
            <table width="405" border="1" cellpadding="2" cellspacing="2" bgcolor="#ADADAD" bordercolor="#ADADAD">
              <tr>
                <td colspan="5" bgcolor="#FFFFFF" class="title" align="center"><font face="黑体" color=#000 size=3>上传产品</font></td>
              </tr>
              <tr class="title">
