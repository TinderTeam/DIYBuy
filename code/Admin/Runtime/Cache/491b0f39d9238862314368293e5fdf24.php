<?php if (!defined('THINK_PATH')) exit();?>    <!DOCTYPE HTML> 
    ...
    <body> 
    <div class="wrap"> 
      <form name="form" action="__URL__/check" method="post"> 
        <section class="loginForm"> 
          ...
          <div class="loginForm_content"> 
            <fieldset> 
              <div class="inputWrap"> 
                <input type="text" name="admin_name" placeholder="邮箱/手机号" autofocus required> 
              </div> 
              <div class="inputWrap"> 
                <input type="password" name="admin_pwd" placeholder="请输入密码" required> 
              </div> 
            </fieldset> 
            <fieldset> 
            ...
            <fieldset> 
              <input type="submit" value="登录" onclick="return check(form);"> 
