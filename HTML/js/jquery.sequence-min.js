...
(function(e) {
    function n(n, r, i, s) {
        function f() {
            ...
            } else o.settings.preloader.fadeOut(o.settings.hidePreloaderDelay,
            function() {
        ...
        function p(t, n) {
            ...
            u.length ? u.bind("load.imagesLoaded error.imagesLoaded",
            function(e) {
        ...
        function g() {
            ...
            if (o.pagination !== undefined && o.pagination !== !1) {
                ...
                o.paginationLinks.on("click.sequence",
                function() {
            ...
            o.nextButton !== undefined && o.nextButton.bind("click.sequence",
            function() {
                o.next()
            });
            o.prevButton !== undefined && o.prevButton.bind("click.sequence",
            function() {
                o.prev()
            });
            o.pauseButton !== undefined && o.pauseButton.bind("click.sequence",
            function() {
                o.pause(!0)
            });
            if (o.settings.keyNavigation) {
                ...
                e(document).bind("keydown.sequence",
                function(e) {
            ...
            o.settings.hashTags && e(window).bind("hashchange.sequence",
            function() {
        ...
        o.animationPrefix = u[ModernizrForSequence.prefixed("animation")],
        o.transitionProperties = {},
        o.transitionEnd = a[ModernizrForSequence.prefixed("transition")] + " " + a[ModernizrForSequence.prefixed("animation")],
        o.numberOfFrames = o.frames.length,
        o.transitionsSupported = o.transitionPrefix !== undefined ? !0 : !1,
        o.hasTouch = "ontouchstart" in window ? !0 : !1,
        o.isPaused = !1,
        o.isBeingHoveredOver = !1,
        o.container.removeClass("sequence-destroyed");
        o.paused = function() {},
        o.unpaused = function() {},
        ...
        } else e(window).bind("load.sequence",
        function() {
            f();
            e(this).unbind("load.sequence")
        });
    ...
    n.prototype = {
                ...
                if (i.transitionsSupported) {
                    ...
                    if (!i.settings.reverseAnimationsWhenNavigatingBackwards || i.direction === 1) {
                        setTimeout(function() {
                            ...
                            i._waitForAnimationsToComplete(i.nextFrame, i.nextFrameChildren, "in"); (i.afterCurrentFrameAnimatesOut !== "function () {}" || i.settings.transitionThreshold === !0 && r !== !0) && i._waitForAnimationsToComplete(i.currentFrame, i.currentFrameChildren, "out", !0, 1)
                        },
                        50);
                        setTimeout(function() {
                    ...
                    default:
                        ...
                        i.currentFrame = i.frames.eq(i.currentFrameID - 1);
                        i.beforeCurrentFrameAnimatesOut();
                        i.currentFrame.animate(u, i.settings.fallback.speed,
                        function() {
                            i.currentFrame.css({
                                display: "none",
                                "z-index": "1"
                        ...
                        i.nextFrame.css({
                            display: "block",
                            "z-index": i.numberOfFrames
                        }).animate(f, i.settings.fallback.speed,
                        function() {
                            o();
                            i.afterNextFrameAnimatesIn()
                        })
        ...
        _renderUiElements: function(t, n) {
            ...
            case ! 0 : n === ".sequence-preloader" && r._defaultPreloader(r.container, r.transitionsSupported, r.animationPrefix);
                return e(n);
            default:
                return e(t)
            }
        ...
        _modernizrForSequence: function() {
            window.ModernizrForSequence = function(e, t, n) {
                ...
                k,
                L = {}.hasOwnProperty,
                A; ! s(L, "undefined") && !s(L.call, "undefined") ? A = function(e, t) {
                    return L.call(e, t)
                }: A = function(e, t) {
